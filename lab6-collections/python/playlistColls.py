...
piecesFromThings = [piece for piece in things if piece.__class__ == Piece] #TASK 5.3.(c)
...
shortItemLenghts1 = [ item for item in playlist1 if item.length_secs < 20] # TASK 6.3.(b)
